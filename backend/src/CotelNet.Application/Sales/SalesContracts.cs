...
public sealed record SaleDto(int Id, string InvoiceNumber, DateTime CreatedAtUtc, decimal Total, IReadOnlyList<SaleLineDto> Lines, IReadOnlyList<PaymentSummaryDto> Payments, ShipmentDto? Shipment);
